...
class CoreBaseCLI {
    ...
    loadDefaultPlugin() {
        ...
        const currentNodeModules = (0, path_1.join)(cwd, 'node_modules');
        deps.forEach(dep => {
            const npmPath = (0, path_1.join)(currentNodeModules, dep);
            if (!(0, fs_1.existsSync)(npmPath)) {
                throw new Error(`Auto load mw plugin error: '${dep}' not install in '${currentNodeModules}'`);
            }
            try {

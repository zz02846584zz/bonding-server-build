...
exports.findMidwayVersion = exports.formatModuleVersion = exports.formatInstallNpmCommand = exports.findNpm = exports.resolveMidwayConfig = exports.findNpmModule = exports.loadNpm = exports.installNpm = exports.getCoreBaseDir = void 0;
...
const findNpmModuleByResolve = (cwd, modName) => {
    try {
        return (0, path_1.dirname)(require.resolve(`${modName}/package.json`, { paths: [cwd] }));
    }
    catch (e) {
        return;
    }

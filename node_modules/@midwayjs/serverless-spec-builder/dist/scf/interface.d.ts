...
export declare type SCFEventType = SCFAPIGatewayEvent | SCFCKafkaEvent | SCFCMQEvent | SCFCOSEvent | SCFTimerEvent;
...
export declare type SCFHTTPMethod = 'ANY' | 'GET' | 'POST' | 'PUT' | 'DELETE' | 'HEAD';

export declare type SpecTransformer = (builder: Builder) => string;
...
export declare type EventTypeKey = 'http' | 'timer' | 'os' | 'log' | 'apigw' | 'mq';
export declare type EventType = HTTPEvent | TimerEvent | LogEvent | OSEvent | APIGatewayEvent;
...
export declare type APIGatewayEvent = HTTPEvent;
...
export declare type PluginsStructure = string[];

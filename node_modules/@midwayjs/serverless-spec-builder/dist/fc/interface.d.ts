...
export declare type FCServiceType = 'Aliyun::Serverless::Service';
export declare type FCFunctionType = 'Aliyun::Serverless::Function';
export declare type FCCustomDomainType = 'Aliyun::Serverless::CustomDomain';
export declare type FCLogType = 'Aliyun::Serverless::Log';
export declare type FCLogStoreType = 'Aliyun::Serverless::Log::Logstore';
...
export declare type HTTPEventType = 'GET' | 'POST' | 'PUT' | 'DELETE' | 'HEAD' | 'PATCH';

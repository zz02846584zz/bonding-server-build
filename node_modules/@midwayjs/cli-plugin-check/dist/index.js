...
class CheckPlugin extends command_core_1.BasePlugin {
    ...
    async start() {
        ...
        let tsCodeRoot = (0, path_1.join)(cwd, 'src');
        let locateResult;
        ...
        if ((0, fs_1.existsSync)(pkgJsonFile)) {
            this.pkg = JSON.parse((0, fs_1.readFileSync)(pkgJsonFile).toString());
        }
        this.globalData = {
            cwd,
    ...
    async projectStruct() {
        ...
        return runner => {
            runner
                ...
                .check('project type', () => {
                var _a;
                if (!((_a = this.globalData.locateResult) === null || _a === void 0 ? void 0 : _a.projectType) ||

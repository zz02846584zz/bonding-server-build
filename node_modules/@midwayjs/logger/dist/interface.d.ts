...
export declare type LoggerCustomInfoHandler = (info: MidwayTransformableInfo) => MidwayTransformableInfo;
...
export declare type LoggerLevel = 'all' | 'silly' | 'debug' | 'info' | 'warn' | 'error' | 'none' | 'ALL' | 'DEBUG' | 'INFO' | 'WARN' | 'ERROR' | 'NONE' | 'trace' | 'TRACE';
export declare type LoggerContextFormat = (info: MidwayTransformableInfo, logger?: IMidwayLogger) => string;
export declare type JSONLoggerContextFormat = (info: MidwayTransformableInfo, meta: {
    level: string;
    LEVEL: string;
    message: string;
    ctx: any;
...
export declare type ChildLoggerOptions = Pick<LoggerOptions, 'format' | 'jsonFormat'>;
export declare type ContextLoggerOptions = Pick<LoggerOptions, 'contextFormat' | 'jsonFormat'>;
